...
public class WebUrls {
    ...
    public static class Urls {
        ...
        public static final String YANDEX = "https://ya.ru/?nr=1&redirect_ts=1675949275.19862";
    }

    /**
     * Класс, содержащий в себе константы для поисковой системы Google
     */
    public static class Google {
        public static final String INPUT_FIELD = "//input[@title='Поиск']";
        public static final String BUTTON_SEARCH = "//div/center/input[@value='Поиск в Google']";

        public static String RESULTS_OF_SEARCH(String request) {
            return "//*[text()='Результаты поиска']/following-sibling::*/*//div[@data-sokoban-container or @class='g']//h3[contains(.,'" + request + "')]";
        }
    }

    /**
     * Класс, содержащий в себе константы для сайта Открытие
     */
    public static class OtkritieBank {
        public static final String BLOCK_EXCHANGE = "//*[@class='CurrencyExchangeFilterContent_currency-exchange-filter-content-column-wrapper__AzUkf']";
        public static final String TEXT_EXCHANGE = ".//div[@class='CurrencyExchangeItem_currency-exchange-item-wrapper__b_tuv']//span[text()]";
    }
    ...
    /**
     * Класс, содержащий в себе константы для сайта Википедия
     */
    public static class Wikipedia {
        public static final String TABLE_ON_PAGE = "//*[@id='mw-content-text']/div/table[1]";
        public static final String TABLE_ROWS = "//*[@id='mw-content-text']/div/table[1]//tbody/tr";
    }
}
